...
export const PrinterSettingsView: React.FC = () => {
	...
	const handleConfigChange = (field: keyof PrinterConfig, value: string | number | boolean) => {
		setConfig(prev => ({
			...prev,
			[field]: value
		}));
			...
			<div className="w-full h-full flex items-center justify-center p-4">
				<div className="w-full max-w-2xl space-y-6">
					...
					<div className="flex items-center justify-between">
						...
						<h1 className="text-2xl font-bold text-white">Configuración de Impresora</h1>
					</div>
						...
						<div className="bg-gray-800 rounded-lg p-6 space-y-6">
							...
							<div className="grid grid-cols-2 gap-4">
								...
								<TouchInput
									...
									onChange={(value) => handleConfigChange('port', parseInt(value) || 9100)}
									label="Puerto"
									placeholder="9100"
									maxLength={5}
									keyboardMode="numeric"
							...
							<TouchSelect
								...
								onChange={(value) => handleConfigChange('paperWidth', parseInt(value))}
							...
							<div className="border-t border-gray-600 pt-4">
								<h3 className="text-lg font-semibold text-white mb-4">Test de Conexión</h3>
								<div className="flex items-center justify-between mb-4">
									<div className="flex items-center space-x-3">
										{getTestStatusIcon()}
										<div>
											<p className="text-white font-medium">
												Estado: {testStatus === 'testing' ? 'Probando...' :
														testStatus === 'success' ? 'Conectado' :
														testStatus === 'error' ? 'Error de conexión' : 'No probado'}
											</p>
											{testResult && (
					...
					{hasUnsavedChanges && (
						<div className="bg-yellow-900 border border-yellow-600 rounded-lg p-4">
							<p className="text-yellow-200 text-sm">
								⚠️ Tiene cambios sin guardar. Asegúrese de guardar la configuración antes de salir.
							</p>
						</div>
					)}
				</div>
